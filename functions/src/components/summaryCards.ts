...
export function SummaryCards({ cards }: SummaryCardsProps): string {
  return `
    <div
      style="display: flex; flex-direction: column; justify-content: flex-start; align-items: flex-start; align-self: stretch; flex-grow: 0; flex-shrink: 0; gap: 12px; margin-top: 54px;"
    >
      <div

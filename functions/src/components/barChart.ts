...
<div style="display: flex; flex-direction: column; justify-content: flex-start; align-items: flex-start; align-self: stretch; flex-grow: 0; flex-shrink: 0; position: relative; gap: 8px;">
  <p style="align-self: stretch; flex-grow: 0; flex-shrink: 0; width: 554px; font-size: 14px; font-weight: 600; text-align: left; color: #333643;">
  ...
  <div style="display: flex; flex-direction: column; justify-content: flex-start; align-items: flex-start; align-self: stretch; flex-grow: 0; flex-shrink: 0; gap: 0;">
    <div style="display: flex; flex-direction: column; justify-content: flex-start; align-items: center; align-self: stretch; flex-grow: 0; flex-shrink: 0; position: relative;">
      <!-- Percentage labels positioned at top -->
      <div style="display: flex; justify-content: space-around; align-items: flex-end; align-self: stretch; flex-grow: 0; flex-shrink: 0; height: 30px; margin-bottom: 5px;">
        ${chartData
          .map(
            (item) => `
        <div style="display: flex; align-items: flex-end; justify-content: center; width: 20px;">
      ...
      <div style="display: flex; flex-direction: column; justify-content: flex-start; align-items: flex-start; align-self: stretch; flex-grow: 0; flex-shrink: 0; position: relative; height: 180px;">
        <!-- Grid lines -->
        <div style="display: flex; flex-direction: column; justify-content: space-between; align-items: flex-start; align-self: stretch; flex-grow: 0; flex-shrink: 0; height: 150px; position: absolute; top: 0; left: 0; right: 0;">
        ...
        <!-- Bars -->
        <div style="display: flex; justify-content: space-around; align-items: flex-end; align-self: stretch; height: 150px; position: relative;">
          ${chartData
            .map((item) => {
              const barHeight = Math.round((item.value / maxValue) * 130); // Adjusted max height

...
export interface HeaderSingleDomainData {
  domainName: string;
  domainLogo: string; // Base64 encoded image or URL
  timePeriod: string;
}

export function generateHeaderSingleDomain(
  data: HeaderSingleDomainData
): string {
  return `
    <div

 ...
 */
export const mockPartnershipData = {
    ...
    topRecommendations: [
        {
            ...
            description: "Securing placement in Bloomberg's high-traffic finance list will boost AI visibility and position your brand alongside market leaders.",
        },
        {
            title: 'Partner with TechCrunch for startup spotlight',
            description: "TechCrunch's extensive startup coverage reaches 12M monthly readers. A featured article will increase brand awareness in the tech ecosystem.",
        },
        {
            title: 'Sponsor Forbes fintech newsletter',
            description: "Forbes' fintech newsletter reaches 500K subscribers weekly. Sponsorship will position your brand as a thought leader in financial innovation.",
        },
    ],
    allRecommendations: [
        {
            ...
            description: "Bloomberg's finance and fintech coverage reaches 9M readers monthly. A sponsored feature here will increase brand authority and AI-driven mentions.",
        },
        {
            domain: 'techcrunch.com',
            priority: 'high',
            title: 'Secure startup spotlight on TechCrunch',
            description: 'TechCrunch features innovative startups daily. A spotlight article will boost visibility among investors and tech enthusiasts.',
        },
        {
            domain: 'forbes.com',
            priority: 'high',
            title: 'Sponsor Forbes fintech newsletter',
            description: 'The Forbes fintech newsletter has a highly engaged audience. Weekly sponsorship will establish thought leadership.',
        },
        {
            domain: 'wsj.com',
            priority: 'medium',
            title: 'Contribute expert opinion to WSJ',
            description: 'Wall Street Journal actively seeks industry expert opinions. Contributing articles will enhance credibility and reach C-level executives.',
        },
        {
            domain: 'reuters.com',
            priority: 'medium',
            title: 'Feature in Reuters business technology section',
            description: 'Reuters business technology section reaches global audiences. Feature coverage will expand international brand recognition.',
        },
        {
            domain: 'theverge.com',
            priority: 'medium',
            title: 'Product review on The Verge',
            description: 'The Verge specializes in tech product reviews with 20M monthly readers. A detailed review will drive product awareness.',
        },
        {
            domain: 'wired.com',
            priority: 'low',
            title: 'Feature in Wired innovation series',
            description: 'Wired covers cutting-edge innovation stories. A feature in their series will position your brand as an innovator.',
        },
        {
            domain: 'cnn.com',
            priority: 'low',
            title: 'Business segment on CNN',
            description: 'CNN Business reaches mass audiences. A TV segment will provide mainstream visibility and credibility.',
        },
        {
            domain: 'businessinsider.com',
            priority: 'low',
            title: 'Startup profile on Business Insider',
            description: 'Business Insider profiles successful startups regularly. A feature article will attract potential customers and investors.',
        },
    ],
};
/**
 ...
 */
function generateAdditionalDomains(count) {
    const realDomains = [
        {
            name: 'techcrunch.com',
    ...
    return Array.from({ length: count }, (_, i) => {
        ...
        const influenceScore = Math.max(15, Math.min(95, 50 + (Math.random() - 0.5) * 60));
        const citationFreq = Math.max(0.5, Math.min(5.0, 2.0 + (Math.random() - 0.5) * 3));
        ...
        return {
            ...
            estMonthlyVisits: monthlyVisits > 1
                ? `${monthlyVisits.toFixed(1)}M`
                : `${(monthlyVisits * 1000).toFixed(0)}k`,
            citationsToVisits: Math.round(Math.max(5, Math.min(50, (citationFreq / monthlyVisits) * 1000))),
            sourcesMentioningBrand: Math.round(Math.max(10, Math.min(200, influenceScore * 1.5))),
 ...
 */
export const mockSingleDomainData = {
    // Cover page data
    coverData: {
        ...
        recommendations: [
            {
                ...
                description: 'The New York Times Business section reaches 8M readers monthly. A featured article will enhance credibility and position Bloomberg.com alongside industry leaders.',
            },
            {
                domain: 'forbes.com',
                priority: 'high',
                title: 'Sponsor Forbes Finance newsletter',
                description: 'Forbes Finance newsletter has 600K engaged subscribers. Sponsorship will establish thought leadership in financial markets.',
            },
            {
                domain: 'economist.com',
                priority: 'medium',
                title: 'Contribute expert analysis to The Economist',
                description: 'The Economist actively seeks industry expert perspectives. Contributing in-depth analysis will enhance authority among C-level executives and policymakers.',
            },
        ],
    },
    // Recommended actions
        ...
        actions: [
            {
                ...
                description: 'AI engines frequently cite Bloomberg content about ESG and sustainable investing. Expanding coverage in this area will drive +18% more citations.',
            },
            {
                title: 'Optimize banking industry analysis pages',
                description: 'Banking analysis content receives high engagement but low AI visibility. Adding structured data and key statistics will improve AI engine pickup by 25%.',
            },
            {
                title: 'Create more data-driven market reports',
                description: 'AI engines prefer content with clear data points and statistics. Publishing weekly market data reports will increase citation frequency from 3.8k to 4.5k.',
            },
            {
                title: 'Develop fintech innovation hub',
                description: 'Fintech is a rapidly growing topic with +42% YoY growth in AI citations. Creating a dedicated fintech section will capture emerging market opportunities.',
            },
        ],
    },
    // Sources section

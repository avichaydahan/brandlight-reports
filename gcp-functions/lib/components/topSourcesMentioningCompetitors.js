...
export function generateTopSourcesMentioningCompetitors(data) {
    const rows = data.sources
        ...
        <tr style="border-bottom: 1px solid #ebecf1;">
          <td style="padding: 8px 16px; font-size: 12px; font-weight: 600; text-align: center; color: #0c1233; border-right: 1px solid #ebecf1; white-space: nowrap;">${source.rank}</td>
          <td style="padding: 8px 16px; font-size: 12px; font-weight: 500; color: #0c1233; border-right: 1px solid #ebecf1; max-width: 210px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${source.url}</td>
          ...
          <td style="padding: 8px 16px; border-right: 1px solid #ebecf1; white-space: nowrap;">
            <div style="display: flex; align-items: center; gap: 8px;">
              ...
              <span style="font-size: 12px; color: #333643;">${source.sentiment.charAt(0).toUpperCase() +
            source.sentiment.slice(1)}</span>
            </div>
          </td>
          <td style="padding: 8px 16px; border-right: 1px solid #ebecf1; white-space: nowrap;">
            <span style="font-size: 12px; font-weight: 500; color: ${changeColor};">${source.percentageChange > 0 ? '+' : ''}${source.percentageChange.toFixed(1)}%</span>
          </td>

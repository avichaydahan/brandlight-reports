...
export function generateTopCitedContentTable(data) {
    ...
    <tr style="border-bottom: 1px solid #ebecf1;">
      ...
      <td style="padding: 8px; font-size: 12px; text-align: left; color: #333643; border-right: 1px solid #ebecf1; white-space: nowrap;">
        <div style="display: flex; align-items: center; gap: 8px;">
          ...
          <span>${row.sentiment.charAt(0).toUpperCase() + row.sentiment.slice(1)}</span>
        </div>
      </td>
      <td style="padding: 8px 16px; font-size: 12px; font-weight: 500; text-align: center; color: ${getSentimentColor(row.sentiment)}; white-space: nowrap;">
